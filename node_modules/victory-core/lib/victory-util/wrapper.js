...
var _default = {
  ...
  getStringsFromCategories: function (childComponents, axis) {
    var iteratee = function (child) {
      ...
      if (!_domain.default.isDomainComponent(child) || !childProps.categories) {
        ...
        return _data.default.getStringsFromCategories(childProps, axis);
      }
    };
  ...
  getStringsFromChildren: function (props, axis, childComponents) {
    ...
    return (0, _uniq2.default)((0, _flatten2.default)(_toConsumableArray(categoryStrings).concat(_toConsumableArray(dataStrings), _toConsumableArray(axisStrings))));
  },
  getCategories: function (props, axis) {
    var categories = _data.default.getCategories(props, axis) || this.getStringsFromChildren(props, axis);
